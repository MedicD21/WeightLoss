...
final class BodyWeightEntry {
    ...
    func weightDisplay(useMetric: Bool) -> String {
        if useMetric {
            ...
            return String(format: "%.1f lb", UnitConverter.kgToLb(weightKg))
        }
    }
}
...
final class WaterEntry {
    ...
    var amountDisplay: String {
        let ounces = UnitConverter.mlToFlOz(amountMl)
...
struct DailySummary {
    ...
    // Water
    var waterMl: Int = 0
    var waterGoalMl: Int = Constants.Defaults.dailyWaterGoalMl
