                ...
                VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                    HStack {
                        Text("Weekly Rate")
                            ...
                            .foregroundColor(Theme.Colors.textPrimary)
                        Spacer()
                        Text(String(format: "%.2f kg/week", goalRate))
                            .font(Theme.Typography.headline)
                            .foregroundColor(Theme.Colors.accent)
                    }

                    Slider(value: $goalRate, in: 0.25...1.0, step: 0.25)
                        .tint(Theme.Colors.accent)

                    Text(goalType == .cut ? "0.5 kg/week is recommended for sustainable fat loss" : "0.25 kg/week is recommended for lean muscle gain")
                        .font(Theme.Typography.caption)
    ...
    var body: some View {
        VStack(spacing: Theme.Spacing.xl) {
            ...
            VStack(spacing: Theme.Spacing.sm) {
                ...
                SummaryRow(label: "Height", value: String(format: "%.0f cm", height))
                SummaryRow(label: "Weight", value: String(format: "%.1f kg", weight))
